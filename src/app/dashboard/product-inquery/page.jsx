...
export default function ProductQueryPage() {
    ...
    const fetchLogs = async (page = 1) => {
        ...
        try {
            ...
            // console.log("last_page:", data.pagination?.last_page); 
            ...
            <div className="overflow-x-auto">
                <table className="w-full min-w-[700px] border border-gray-300 border-collapse text-sm mt-4 mb-6 shadow">
                    <thead className="bg-[#b3ffd3]">
                        <tr>
                            <th className="border px-2 py-2 text-center">S.No</
                            th>
                            <th className="border px-2 py-2 text-left">Unique ID</th>
                            ...
                            logs.map((log, i) => (
                                <tr key={log.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="border px-2 py-2">
                                        <p className="font-semibold">{log.user?.unique_code
                                            ? String(log.user.unique_code).padStart(3, '0')
                                            : 'N/A'}</p>
                                    </td>
